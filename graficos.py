...
plt.ylabel("Cantidad")
plt.savefig("grafico_1_jugadores_por_equipo.png")
...
plt.xlabel("Cantidad")
plt.tight_layout()
plt.savefig("grafico_2_jugadas_por_jugador.png")
...
plt.legend()
plt.tight_layout()
plt.savefig("grafico_3_puntaje_por_equipo_tiempo.png")
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("grafico_4_equipos_por_ventana.png")
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("grafico_5_jugadores_por_ventana.png")
